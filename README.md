...
The blog is a hiking blog that gives hiking tips for my home town Stjørdal.
The blog content is created with WordPress, and the data is being fetched using WordPress REST API.
...
```bash
git clone https://github.com/Noroff-FEU-Assignments/project-exam-1-martemoslet.git
```
